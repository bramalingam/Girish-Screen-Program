...
for j1=batchlength
    ...
    elseif j1==3
        inputdir=['F:\Dhruv\Girish\70714\PRM GFP\24 hour\MFGTMP_140618000002'];
    elseif j1==4
        inputdir=['F:\Dhruv\Girish\70714\PRM GFP\36 hour\MFGTMP_140618120001'];
    end
    ...
    filepath=filepath{1}; %Why was this done? And how on earth does it work? on Workspce it becomes only the first field location, but bfread works on everything anyway?!!
